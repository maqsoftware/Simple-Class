...
public interface UnitPartDao {
    ...
    UnitPart[] getUnitPartsByUnitIdAndType(Long unitId, int type);
    ...
    EagerUnitPart[] getEagerUnitPartsByUnitIdAndType(Long unitId, int type);

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    void insertUnitPart(UnitPart unitPart);
}
