...
public interface LessonUnitDao {
    ...
    LessonUnit[] getLessonUnitsByLessonId(Long lessonId);
    ...
    List<FlashCard> getFlashCardsByLessonId(Long lessonId);
    ...
    @Query("SELECT lu.*, "
            ...
            + "AND lu.subjectUnitId = su.id "
            + "AND lu.objectUnitId = ou.id")
    FlashCard[] getFlashCardArrayByLessonId(Long lessonId);
    ...
    @Query("SELECT lu.*, "
            ...
            + "AND lu.subjectUnitId = su.id "
            + "AND lu.objectUnitId = ou.id")
    List<FlashCard> getFlashCardArrayBelowSeqAndByConcept(int seq, int concept);
    ...
    @Query("SELECT lu.*, "
            ...
            + "AND lu.subjectUnitId = su.id "
            + "AND lu.objectUnitId = ou.id")
    FlashCard getFlashCardByLessonIdAndSeq(Long lessonId, int seq);

    @Query("SELECT COUNT(*) FROM LessonUnit")
    int count();

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    Long insertLessonUnit(LessonUnit lessonUnit);
}
