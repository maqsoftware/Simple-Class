...
public class FlashCardRepo {
    ...
    public static LiveData<List<FlashCard>> getFlashCards(Context context, final long lessonId) {
        final MutableLiveData<List<FlashCard>> flashCards = new MutableLiveData();
