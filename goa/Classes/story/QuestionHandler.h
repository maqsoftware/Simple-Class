...
public:
    ...
    static void setButtonProperties(cocos2d::Node *button, std::string name, std::string text, const cocos2d::ui::Widget::ccWidgetTouchCallback &callback, const cocos2d::ui::Widget::ccWidgetTouchCallback &soundCallback, size_t length = 24, const int fontSize = QuestionHandler::FONT_SIZE);
