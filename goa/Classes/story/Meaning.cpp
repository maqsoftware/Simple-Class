...
void Meaning::adjustButtons() {
    ...
    QuestionHandler::setButtonProperties(bg->getChildByName("Node_4")->getChildByName("Button_4"), "4", _questions[7], CC_CALLBACK_2(Meaning::buttonSelected, this), CC_CALLBACK_2(Meaning::soundSelected, this), 16, 50);
    QuestionHandler::setButtonProperties(bg->getChildByName("Node_" + buttons[0])->getChildByName("Button_"+buttons[0]), "1_answer", QuestionHandler::wrapString(_questions[2], 40), CC_CALLBACK_2(Meaning::buttonSelected, this), CC_CALLBACK_2(Meaning::soundSelected, this), 30, 50);
    QuestionHandler::setButtonProperties(bg->getChildByName("Node_" + buttons[1])->getChildByName("Button_"+buttons[1]), "2_answer", QuestionHandler::wrapString(_questions[4], 40), CC_CALLBACK_2(Meaning::buttonSelected, this), CC_CALLBACK_2(Meaning::soundSelected, this), 30, 50);
    QuestionHandler::setButtonProperties(bg->getChildByName("Node_" + buttons[2])->getChildByName("Button_"+buttons[2]), "3_answer", QuestionHandler::wrapString(_questions[6], 40), CC_CALLBACK_2(Meaning::buttonSelected, this), CC_CALLBACK_2(Meaning::soundSelected, this), 30, 50);
    QuestionHandler::setButtonProperties(bg->getChildByName("Node_" + buttons[3])->getChildByName("Button_"+buttons[3]), "4_answer", QuestionHandler::wrapString(_questions[8], 40), CC_CALLBACK_2(Meaning::buttonSelected, this), CC_CALLBACK_2(Meaning::soundSelected, this), 30, 50);
