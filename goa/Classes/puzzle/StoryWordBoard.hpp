...
public:
    ...
    static StoryWordBoard* createWithWords(std::string const& storyId, std::vector<std::string> const& words, int currentIndex, std::string baseDir,int totalPoints, int currentPoints);
