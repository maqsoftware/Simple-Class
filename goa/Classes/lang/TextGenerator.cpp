...
std::vector<std::vector<std::string>> TextGenerator::generateMatrix( std::string const& word, int numRows, int numCols) {
...
int TextGenerator::getNumGraphemesInString( std::string const& word) {
...
std::vector<std::string> TextGenerator::getValidCombinations( std::string const& chars, int maxLength) {
...
std::map<std::string, std::string> TextGenerator::getPairs( std::string const& type, int maxNum, int level) {
...
std::map<std::string, std::string> TextGenerator::getPairsNotForLevel(std::string const& type, int maxNum, int level) {
    std::string contents = cocos2d::FileUtils::getInstance()->getStringFromFile(LangUtil::getInstance()->getDir() + "/" + type + ".csv");
    std::vector<std::pair<std::string, std::string>> pairs;
    std::stringstream ss;
    ss.str(contents);
...
std::vector<std::string> TextGenerator::getWordList( std::string const& type, int level, int maxNum) {
    std::string contents = cocos2d::FileUtils::getInstance()->getStringFromFile(LangUtil::getInstance()->getDir() + "/" + type + ".csv");
...
std::string TextGenerator::getSingle( std::string const& type, int level, int length) {
    std::string contents = cocos2d::FileUtils::getInstance()->getStringFromFile(LangUtil::getInstance()->getDir() + "/" + type + ".csv");
    std::vector<std::string> pairs;
    std::stringstream ss;
    ss.str(contents);
...
std::map<std::string, std::map<std::string, std::string>> TextGenerator::getMapOfWords( std::string const& type, int maxNum, int maxChoices, int level) {
    std::string contents = cocos2d::FileUtils::getInstance()->getStringFromFile(LangUtil::getInstance()->getDir() + "/" + type + ".csv");
...
std::vector<std::vector<std::string>> TextGenerator::getListsOfWords( std::string const& type, int level, int maxNum) {
    std::string contents = cocos2d::FileUtils::getInstance()->getStringFromFile(LangUtil::getInstance()->getDir() + "/" + type + ".csv");
