...
public:
	...
	std::string id;
	static EventListenerClass* createCannonBall(std::string const& spriteName, EventListenerClass*, EventListenerClass*, EventListenerClass*, int, std::string, float, float, MainGame*);
	static EventListenerClass* createCannon(std::string spriteName, int flag1, int currentShoot1, int totalShoot1, int, float, float);
	static EventListenerClass* createSprite(std::string const& spriteName, float x, float y, std::string, MainGame*);
...
public:
	...
	static LabelClass* createSpt(std::string const& spriteName, float x, float y, std::string wt, MainGame*);
private:
};
