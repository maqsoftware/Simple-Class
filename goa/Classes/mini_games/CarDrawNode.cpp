...
cocos2d::ui::Button *carDrawNode::createButton(std::string const& normalImage, std::string const& selectedImage, std::string const& disableImage, cocos2d::Vec2 position)
{
